...
// Production-proven JWT provider copied verbatim from a production XAF (Blazor Server) app
// (namespace only changed). Signs with the shared HMAC key; issuer/audience are intentionally omitted to match
// the JwtBearer validation in Startup (ValidateIssuer/ValidateAudience = false).
